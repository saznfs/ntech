...
const BRANDS = [
    { id: "apple", name: "Apple", logoIcon: "fa-apple" },
    { id: "samsung", name: "Samsung", logoIcon: "fa-mobile" },
    { id: "xiaomi", name: "Xiaomi / Redmi / POCO", logoIcon: "fa-microchip" },
    { id: "vivo", name: "Vivo", logoIcon: "fa-cellphone" },
    { id: "oppo", name: "Oppo", logoIcon: "fa-mobile" },
    { id: "realme", name: "Realme", logoIcon: "fa-mobile" },
    { id: "google", name: "Google Pixel", logoIcon: "fa-g" },
    { id: "oneplus", name: "OnePlus", logoIcon: "fa-plus" },
    { id: "anker", name: "Anker", logoIcon: "fa-plug" },
    { id: "jbl", name: "JBL", logoIcon: "fa-music" },
    { id: "baseus", name: "Baseus", logoIcon: "fa-bolt" }
];
