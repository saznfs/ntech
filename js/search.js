        ...
        ${PRODUCTS.slice(0, 3).map(prod => `
            <div class="search-item-card" onclick="openProductModal('${prod.id}')">
                ...
                <div class="search-item-details">
                    ...
                    <div class="search-item-sub">${prod.brand} • <strong style="color:var(--accent-cyan);">${prod.price}</strong></div>
                </div>
        ...
        html += matchedProducts.map(p => `
            <div class="search-item-card" onclick="openProductModal('${p.id}')">
                ...
                <div class="search-item-details">
                    ...
                    <div class="search-item-sub">${p.brand} • <strong style="color:var(--accent-cyan);">${p.price}</strong></div>
                </div>
